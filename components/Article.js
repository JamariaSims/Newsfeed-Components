...
const articleMaker = (props) => {
	//Defining Vars
	const { title, date, firstParagraph, secondParagraph, thirdParagraph } =
		props;
...
data.forEach((x) => {
	//Append The Return Of ArticleMaker For Each Article
	document.body.appendChild(articleMaker(x));
});
